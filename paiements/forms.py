...
class CompteEcoBanqueClientForm(forms.ModelForm):
    class Meta:
        ...
        fields = ['client', 'montant_verset', 'montant_initial', 'montant_restant', 'montant_sorti', 'montant_exact_compte', 'date_operation', 'motif']
        widgets = {
            ...
            'montant_exact_compte': forms.NumberInput(attrs={'step': '0.01'}),
